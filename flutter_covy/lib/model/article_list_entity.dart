...
ArticleListEntity articleListEntityFromJson(String str) => ArticleListEntity.fromJson(json.decode(str));

String articleListEntityToJson(ArticleListEntity data) => json.encode(data.toJson());
...
class ArticleListEntity {
    ...
    factory ArticleListEntity.fromJson(Map<dynamic, dynamic> json) => ArticleListEntity(
        data: ArticleListEntityData.fromJson(json["data"]),
...
class ArticleListEntityData {
    ArticleListEntityData({
        required this.over,
    ...
    factory ArticleListEntityData.fromJson(Map<dynamic, dynamic> json) => ArticleListEntityData(
        over: json["over"],
