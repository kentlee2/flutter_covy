...
ProjectListEntity projectListEntityFromJson(String str) => ProjectListEntity.fromJson(json.decode(str));

String projectListEntityToJson(ProjectListEntity data) => json.encode(data.toJson());
...
class ProjectListEntity {
    ...
    ProjectListEntityData data;
    int errorCode;
    String errorMsg;

    factory ProjectListEntity.fromJson(Map<dynamic, dynamic> json) => ProjectListEntity(
        data: ProjectListEntityData.fromJson(json["data"]),
...
class ProjectListEntityData {
    ProjectListEntityData({
        required this.over,
    ...
    factory ProjectListEntityData.fromJson(Map<dynamic, dynamic> json) => ProjectListEntityData(
        over: json["over"],
