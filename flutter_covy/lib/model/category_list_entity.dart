...
CategoryListEntity categoryListEntityFromJson(String str) => CategoryListEntity.fromJson(json.decode(str));

String categoryListEntityToJson(CategoryListEntity data) => json.encode(data.toJson());
...
class CategoryListEntity {
    ...
    factory CategoryListEntity.fromJson(Map<dynamic, dynamic> json) => CategoryListEntity(
